...
let Contract = (_dec = NearBindgen({}), _dec2 = view(), _dec3 = call({}), _dec(_class = (_class2 = class Contract {
  constructor({
    owner_id
  } = {
  ...
  set_owner({
    ...
    if (predecessorAccountId() !== this.owner_id) {
      undefined("Only owner can change owner");
    }
    this.owner_id = new_owner;
  }
}, _applyDecoratedDescriptor(_class2.prototype, "get_owner", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "get_owner"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_owner", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "set_owner"), _class2.prototype), _class2)) || _class);
function set_owner() {
  ...
  const _result = _contract.set_owner(_args);
...
export { Contract as default, get_owner, set_owner };
