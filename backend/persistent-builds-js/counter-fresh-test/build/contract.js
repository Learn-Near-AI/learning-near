...
let Counter = (_dec = NearBindgen({}), _dec2 = view(), _dec3 = call({}), _dec4 = call({}), _dec5 = call({}), _dec(_class = (_class2 = class Counter {
  ...
  increment() {
    this.counter += 1;
    log(`Counter incremented to: ${this.counter}`);
  }
  decrement() {
    this.counter -= 1;
    log(`Counter decremented to: ${this.counter}`);
  }
  reset() {
    this.counter = 0;
    log('Counter reset to 0');
  }
}, _applyDecoratedDescriptor(_class2.prototype, "get_counter", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "get_counter"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "increment", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "increment"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "decrement", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "decrement"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "reset", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "reset"), _class2.prototype), _class2)) || _class);
function reset() {
...
function get_counter() {
  ...
  const _args = Counter._getArgs();
  const _result = _contract.get_counter(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Counter._serialize(_result, true));
}

export { decrement, get_counter, increment, reset };
