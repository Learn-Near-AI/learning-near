...
let TokenContract = (_dec = NearBindgen({}), _dec2 = call({}), _dec3 = view(), _dec4 = view(), _dec(_class = (_class2 = class TokenContract {
  constructor() {
    this.balances = {};
    this.totalSupply = 0;
  }
  mint({
    ...
    log(`Minted ${amount} tokens to ${account}`);
  }
  get_balance({
    account
  }) {
...
}, _applyDecoratedDescriptor(_class2.prototype, "mint", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "mint"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_balance", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "get_balance"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_total_supply", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "get_total_supply"), _class2.prototype), _class2)) || _class);
function get_total_supply() {
  const _state = TokenContract._getState();
  if (!_state && TokenContract._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = TokenContract._create();
  if (_state) {
    TokenContract._reconstruct(_contract, _state);
  }
  const _args = TokenContract._getArgs();
  const _result = _contract.get_total_supply(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(TokenContract._serialize(_result, true));
}
...
function mint() {
  ...
  TokenContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(TokenContract._serialize(_result, true));
}

export { TokenContract as default, get_balance, get_total_supply, mint };
