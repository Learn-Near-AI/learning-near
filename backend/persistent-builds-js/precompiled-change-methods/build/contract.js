...
let Contract = (_dec = NearBindgen({}), _dec2 = view(), _dec3 = call({}), _dec4 = call({}), _dec(_class = (_class2 = class Contract {
  constructor({
    greeting
  } = {
    greeting: "hello"
  ...
  set_greeting({
    ...
    log(`Changing greeting to: ${greeting}`);
    this.greeting = greeting;
  }
  append_suffix({
    suffix
...
}, _applyDecoratedDescriptor(_class2.prototype, "get_greeting", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "get_greeting"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "set_greeting", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "set_greeting"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "append_suffix", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "append_suffix"), _class2.prototype), _class2)) || _class);
function append_suffix() {
  ...
  const _result = _contract.append_suffix(_args);
...
export { append_suffix, Contract as default, get_greeting, set_greeting };
